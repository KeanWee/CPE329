...
volatile int sineValues[50] = {0, 125, 249, 368, 482, 588, 685, 771, 844, 905, 951, 982, 998, 998, 982, 951, 905, 844, 771, 685, 588, 482, 368, 249, 125, 0, -125, -249, -368, -482, -588, -685, -771, -844, -905, -951, -982, -998, -998, -982, -951, -905, -844, -771, -685, -588, -482, -368, -249, -125};
int main(void){
  ...
  CCR0 = (16000000 / 5000);                             // Sets interrupt trigger at 10 ms
...
void GenerateSineWave()
{
   Drive_DAC(sineValues[SinCount]+1000);
   SinCount++;
   if (SinCount == 50)
     SinCount = 0;
}
